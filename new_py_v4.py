...
GYRO_SMOOTH = 0.85                 
EPS_GYRO = 8.0
SCROLL_STEPS = 600                 # 🔥 NEW: How many units to scroll per swipe
...
# Note: If your new 5-class model is saved as gesture_rf.joblib, 
# you might want to point CLICK_MODEL_PATH to that same file!
    ...
    if mouse_active and collecting and fast_sensor_buf:
        ...
        if click_capture_active and (current_time - click_capture_start_time >= ML_CAPTURE_WINDOW_MS):
            ...
            if feat is not None:
                ...
                # 🔥 NEW: All locked gestures happen here!
                ...
                # 🔥 NEW: Gallery Next/Previous Photo
                elif ml_click_pred == "swipe_left":
                    # Swiping left usually means "push this photo away and show the Next one"
                ...
                #     print("Action: RIGHT CLICK")
                    ...
                    # Swiping right usually means "pull the Previous photo back"
